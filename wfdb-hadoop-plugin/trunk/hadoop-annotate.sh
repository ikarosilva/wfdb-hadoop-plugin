...
#Use ${PHYSIONET_RECORD_SAMPLE_SET} for dry-run
#Use $${PHYSIONET_RECORD_FILES} for full run 
INDEX_FILE=${PHYSIONET_RECORD_SAMPLE_SET}
...
${HADOOP_INSTALL}/bin/hadoop jar ${HADOOP_INSTALL}/share/hadoop/tools/lib/hadoop-streaming-2.2.0.jar \
  ...
  -input hdfs://${HDFS_ROOT}/${INDEX_FILE} \
